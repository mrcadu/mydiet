<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="jh-navbar">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">diet</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/food">
            ...
            <span v-text="$t('global.menu.entities.food')">Food</span>
          </b-dropdown-item>
          <b-dropdown-item to="/diet">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.diet')">Diet</span>
          </b-dropdown-item>
          <b-dropdown-item to="/meal">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.meal')">Meal</span>
          </b-dropdown-item>
          <b-dropdown-item to="/user-diet">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.userDiet')">User Diet</span>
          </b-dropdown-item>
