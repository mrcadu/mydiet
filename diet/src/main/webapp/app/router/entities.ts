...
// prettier-ignore
const AddFoodDataProcessDetails = () => import('@/entities/add-food-data-process/add-food-data-process-details.vue');
// prettier-ignore
const AddFoodDataProcessList = () => import('@/entities/add-food-data-process/add-food-data-process-list.vue');
// prettier-ignore
...
// prettier-ignore
const AddFoodDataStartFormInit = () => import('@/entities/add-food-data-process/add-food-data-start-form-init.vue');
// prettier-ignore
...
export default [
  ...
  {
    path: '/process-definition/AddFoodDataProcess/instance/:processInstanceId/view',
    name: 'AddFoodDataProcessView',
    component: AddFoodDataProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/AddFoodDataProcess/instances',
    name: 'AddFoodDataProcessList',
    component: AddFoodDataProcessList,
    meta: { authorities: [Authority.USER] },
  },
  {
  ...
  {
    path: '/process-definition/AddFoodDataProcess/init',
    name: 'AddFoodDataStartFormInit',
    component: AddFoodDataStartFormInit,
    meta: { authorities: [Authority.USER] },
  },
  {
