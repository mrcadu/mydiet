...
import AddFoodDataProcessService from '@/entities/add-food-data-process/add-food-data-process.service';
...
new Vue({
  ...
  provide: {
    ...
    userDietService: () => new UserDietService(),
    addFoodDataProcessService: () => new AddFoodDataProcessService(),
